...
const Post = ({addToCart}) => {
  ...
  const checkServiceabiltiy = async() => {
...
if(pinJson.includes(parseInt(pin))) {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-center rounded" src="https://m.media-amazon.com/images/I/41lDNGz7b8L._UL1050_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="pin mt-6 flex space-x-2 text-sm">
          ...
          <button onClick={checkServiceabiltiy} className='text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded'>Check</button>
        </div>
